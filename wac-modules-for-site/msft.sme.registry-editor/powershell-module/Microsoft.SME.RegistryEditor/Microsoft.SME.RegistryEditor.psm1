function Export-WACRERegistryContent {
<#
...
## [END] Export-WACRERegistryContent ##
function Get-WACRECimRegistrySubKeys {
<#
...
## [END] Get-WACRECimRegistrySubKeys ##
function Get-WACRECimRegistryValues {
<#
...
## [END] Get-WACRECimRegistryValues ##
function Get-WACRERegistrySubKeys {
<#
...
$ErrorActionPreference = "Stop"
$Error.Clear()
Get-ChildItem -LiteralPath $path -ErrorAction SilentlyContinue | Sort-Object -Property PSChildName | ForEach-Object {
    [PSCustomObject]@{
        Name = $_.PSChildName
        Path = $_.PSPath
        ChildCount = $_.SubKeyCount
    }
}

}
## [END] Get-WACRERegistrySubKeys ##
function Get-WACRERegistryValues {
<#
...
## [END] Get-WACRERegistryValues ##
function Get-WACRETemporaryFolder {
<#
...
## [END] Get-WACRETemporaryFolder ##
function Import-WACRERegistryContent {
<#
...
## [END] Import-WACRERegistryContent ##
function New-WACRERegistryKey {
<#
...
## [END] New-WACRERegistryKey ##
function New-WACRERegistryValue {
<#
...
## [END] New-WACRERegistryValue ##
function Remove-WACREFilePath {
<#
...
## [END] Remove-WACREFilePath ##
function Remove-WACRERegistryKey {
<#
...
## [END] Remove-WACRERegistryKey ##
function Remove-WACRERegistryValue {
<#
...
## [END] Remove-WACRERegistryValue ##
function Rename-WACRERegistryKey {
<#
...
## [END] Rename-WACRERegistryKey ##
function Rename-WACRERegistryValue {
<#
...
## [END] Rename-WACRERegistryValue ##
function Search-WACRERegistryKeyAndValue {
<#
...
## [END] Search-WACRERegistryKeyAndValue ##
function Set-WACRERegistryValue {
<#
...
## [END] Set-WACRERegistryValue ##
function Test-WACRERegistryValueExists {
<#
...
## [END] Test-WACRERegistryValueExists ##

# SIG # Begin signature block
# MIIoLQYJKoZIhvcNAQcCoIIoHjCCKBoCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2zdJMu+zUQ3qb
# Xa6UQsYsYYaosFK73QNRiZBGAkFH5qCCDXYwggX0MIID3KADAgECAhMzAAAEhV6Z
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIE28N53x9Qx2T0ce1TdtujtT
# 6erWB7hDw4vaJM3tRHV/MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAB/hEArK+7qv2oNk3aRa59ZvHW+IcW90WTD8wGfcgAHW/JvV055V3b352
# XTYA+riZ1pb7+ngiat0sK0z6osVKFm6Qfzi+Fv5CApLExLg8Vk5Ui98A/zDAXcOI
# 71K7q8uSieOU5t584MrebAYsCkVdHaj0JNBZGrVPkuMHG6i/QLzUIuzc0hMCu0y0
# XKw39rptSj5VkXLQwxfjAcjg5ihqXKxCZzCKJCUg3VS3zGXplm+JuGZV4ieZtnvi
# eSm0MokJCnk+e6QSkEBVPXJ7tHP62iFRCMHstOHbq3kAGp4Kh6/M/k/d61yonKeR
# V1U5wQ8nozgdpIGiTuOSdXuuHMXzcaGCF5cwgheTBgorBgEEAYI3AwMBMYIXgzCC
# F38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAOJdexGPnbRAfG0X1fiIw51E+5mz07J0DN1gTHuz0t2QIGaO/1UBtI
# GBMyMDI1MTExMDE3MTcxOC45ODNaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# MC8GCSqGSIb3DQEJBDEiBCC/6HAb4e0rNhflvYdzNBXEqb492KH9xrLv5Ei7z/FF
...
# Cn9Nf4Fi0M0SQEldABEwDQYJKoZIhvcNAQELBQAEggIACTUmi6nUxOA0IuLtyk4G
# jWnKCe/cE0szyxSDJ2qV/4bXlmRHFAk0gbjysjxomjjXZBuQ66/cs0dAJctvinAH
# vTUmcTZrHU60Qny984gE/IcS/TDQxoxV4YXfufZ3qv4V45Ofz3FnJ4KHFuVA4NUg
# +yFC1tC+DF3S3s+g9DvZr9uLVxk2oLX71IwS0I1wPM3oMYZ1JY+aq2Jnabmc1wv/
# CFb+irUSI8MocrPKjh3bAjnx0KK1w4rWJmnxbbuGNOwuRhSf1wLBVyqcJtmGkgIf
# xlLujmolEPLNFKhwqvtbix1bxWr5WX/ftKFrO7KWU7EU3MB9Sf+Pm+MPh80r0Bld
# UNucHJoFYNJ+hNa4s9YkZX+vnqIHe4kntT9ZZ3HRqKMEbvLrWidGlu/DetmmOGai
# KNqLl7SdPlMsCQnTPWjHOQJo6Q0vfAZtecVVf9ewgEB0BVjbQgQUD/VAWHUOJD0Z
# 2EIFyzXTQfmbHnIrH5dcEBEECJdIjw5LPk4ojT0ZwYbEfYkaKtmng7Yz6ucEkA09
# oUNn4CiYiLqkhHXUk3HeKrybW9joQAbbok5bZz7Ekb5Ndc3j/+QyEEsFa0gMJd4/
# wOP9CZ5lTfeXVxVZ6AE/5v5bsR9YuDm5iFfISaDQFw/DB0yBrmeMrawZ8eUWJNoO
# JYuS64udzQednk1UocUs1Aw=
